#### RE-RUN PANEL B + REASSEMBLE FIGURE FOR ALL REGRESSION_ANALYSIS FOLDERS ####
# Reuses each folder's existing model_fit.rds / posterior_draws.rds / panel_a.rds /
# panel_c.rds / panel_d.rds on disk - only regenerates panel_b.rds (new
# per-plot x-axis window, centered on the distribution with x = 0 always
# visible) and the final composite regression_results.pdf/.png.
...
cat("Done. All 9 regression_results.pdf/.png files regenerated with the new Panel B.\n")
