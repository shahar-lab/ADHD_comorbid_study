...
# reused from aq_regression_analysis's Panel A precedent, deliberately
# outside the blue/vermillion family used for group colors above, per
# COLOR_STANDARD.md.
...
p_panel_a <- ggplot(df, aes(x = group_declared, y = bdi)) +
