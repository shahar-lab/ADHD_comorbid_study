#### FIT BAYESIAN REGRESSION: BDI ~ GROUP ####
...
# (weakly informative, anchored to the BDI-II scale) and the single "b"
# coefficient = ADHD - TD (raw bdi scale, no standardization needed).
regression_priors <- c(
