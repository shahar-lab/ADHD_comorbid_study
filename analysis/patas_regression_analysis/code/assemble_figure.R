...
# Panel A on the left; Panels B, C stacked top-to-bottom on the right. Only
# two stacked panels on the right (no Panel D, since PATAS has no clinical
# cutoff), so the standard 10x8 canvas at normal text sizes fits without the
# extra margin/width tightening the four-panel aq/bdi/ocir figures need.
