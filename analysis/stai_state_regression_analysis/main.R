...
code_dir      <- file.path(project_root, "analysis", "stai_state_regression_analysis", "code")
artifacts_dir <- file.path(project_root, "analysis", "stai_state_regression_analysis", "artifacts")
output_dir    <- file.path(project_root, "analysis", "stai_state_regression_analysis", "output")
...
# 2. Model fitting: stai_state ~ group_declared, user-approved priors (saves to artifacts/)
