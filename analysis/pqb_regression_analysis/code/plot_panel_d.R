...
# linewidth mapped via after_stat(.width) + scale_linewidth_continuous (rather
# than a fixed linewidth = c(2, 1) vector) because this panel maps color/fill
# per group: a fixed-length vector recycled against the two-group x two-width
# combination produces an aesthetic-length mismatch. See sibling
# aq_regression_analysis/code/plot_panel_d.R for the corrected pattern.
