...
code_dir      <- file.path(project_root, "analysis", "wurs_regression_analysis", "code")
artifacts_dir <- file.path(project_root, "analysis", "wurs_regression_analysis", "artifacts")
output_dir    <- file.path(project_root, "analysis", "wurs_regression_analysis", "output")
...
# 2. Model fitting: wurs ~ group_declared, user-approved priors (saves to artifacts/)
...
# 4. Extract posterior draws needed for all four plot panels (saves to artifacts/)
