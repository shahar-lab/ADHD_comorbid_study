...
# Mandatory Style is not a layout knob). Legibility for three stacked panels
# is instead recovered by (a) pushing the left:right column width ratio
# further toward the right column, and (b) tightening plot margins so the
# stacked B/C/D panels lose less vertical space to padding. Body text (axis
# titles/text, legend text/title) is kept within the 10-12pt band required by
# EXPORT_STANDARD.md's checklist.
# ASSUMED[no exact proportions given]: left:right column width ratio of 1:1.3
# and the margin/text sizes below, chosen so three stacked panels stay legible
# within the standard 8-inch height while satisfying both mandates.
