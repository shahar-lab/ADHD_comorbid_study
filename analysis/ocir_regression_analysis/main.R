...
code_dir      <- file.path(project_root, "analysis", "ocir_regression_analysis", "code")
artifacts_dir <- file.path(project_root, "analysis", "ocir_regression_analysis", "artifacts")
output_dir    <- file.path(project_root, "analysis", "ocir_regression_analysis", "output")
...
# 2. Model fitting: ocir ~ group_declared, user-approved priors (saves to artifacts/)
...
# 8b. Panel D numeric summary: posterior median + 90% CI of the proportion
# above cutoff per group (saves to output/)
