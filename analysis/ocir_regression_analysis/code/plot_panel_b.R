...
# safer default because both aq_regression_analysis's and
# bdi_regression_analysis's sibling Panel B ultimately needed
# right-alignment (median close to the max_abs boundary of a symmetric
# +-max_abs axis), and ocir's effect posterior is likely to have similar
# geometry. The orchestrator should re-check this against the actual fitted
# med_diff/max_abs once the pipeline is run, and switch to hjust = -0.05 if
# there turns out to be room on the left instead.
