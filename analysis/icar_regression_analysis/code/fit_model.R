#### FIT BAYESIAN REGRESSION: ICAR ~ GROUP ####
...
# (weakly informative, anchored to the ICAR-16 count-correct scale) and the
# single "b" coefficient = ADHD - TD (raw icar scale, no standardization needed).
regression_priors <- c(
  prior(normal(9, 5), class = "Intercept"),
