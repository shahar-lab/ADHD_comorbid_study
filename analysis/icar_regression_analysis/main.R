...
code_dir      <- file.path(project_root, "analysis", "icar_regression_analysis", "code")
artifacts_dir <- file.path(project_root, "analysis", "icar_regression_analysis", "artifacts")
output_dir    <- file.path(project_root, "analysis", "icar_regression_analysis", "output")
...
# 2. Model fitting: icar ~ group_declared, user-approved priors (saves to artifacts/)
